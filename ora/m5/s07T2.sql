-- examples on transaction anomalies - use a different connection !!!
...
select * from service; -- (4) T2 sees the expected result, T1 sees a phantom!
...
update service set name = name || '_U2' where service_id = 22; -- (3) T2 expected to hang until T1 commit
commit; -- (4)
